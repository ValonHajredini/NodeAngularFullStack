      ...
      <p-card>
        <ng-template pTemplate="header">
          <div class="flex items-center gap-3 p-4">
            ...
            <div>
              <h2 class="text-xl font-bold text-gray-900 m-0">todo app</h2>
              <p class="text-gray-600 text-sm m-0">create a todo app</p>
            </div>
          </div>
        </ng-template>
        ...
        <div class="tool-content">
          @if (loading()) {
            <p-message severity="info" text="Loading todo app..." [closable]="false"></p-message>
          } @else if (error()) {
            <p-message
              severity="error"
            ...
            <div class="text-center py-8">
              ...
              <p class="text-gray-600 mb-4">The todo app tool is ready for implementation.</p>
              <p class="text-sm text-gray-500">Tool Key: todo-app | Component: TodoAppComponent</p>
...
export class TodoAppComponent implements OnInit {
  private readonly todoAppService = inject(TodoAppService);
  ...
  private async initializeTool(): Promise<void> {
    try {
      ...
      await this.todoAppService.initialize();
    } catch (error) {
  ...
  onGetStarted(): void {
    ...
    console.log('todo app tool started');
  }
}
