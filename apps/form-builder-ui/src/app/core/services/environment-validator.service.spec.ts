...
describe('EnvironmentValidatorService', () => {
  ...
  describe('validateEnvironment', () => {
    ...
    it('should throw error for null environment', () => {
      expect(() => service.validateEnvironment(null)).toThrowError(
        'Environment configuration is required',
      );
    });

    it('should throw error for undefined environment', () => {
      expect(() => service.validateEnvironment(undefined)).toThrowError(
        'Environment configuration is required',
      );
    });
    ...
    it('should throw error for missing production property', () => {
      ...
      expect(() => service.validateEnvironment(env)).toThrowError(
        "Environment property 'production' must be a boolean",
      );
    });
    ...
    it('should throw error for invalid apiUrl', () => {
      ...
      expect(() => service.validateEnvironment(env)).toThrowError(
        "Environment property 'apiUrl' must be a non-empty string",
      );
    });
    ...
    it('should throw error for missing features configuration', () => {
      ...
      expect(() => service.validateEnvironment(env)).toThrowError(
        'Environment features configuration is required',
      );
    });
    ...
    it('should throw error for missing JWT configuration', () => {
      ...
      expect(() => service.validateEnvironment(env)).toThrowError(
        'Environment JWT configuration is required',
      );
    });
    ...
    it('should throw error for invalid JWT token expiration buffer', () => {
      const env = {
        ...validEnvironment,
        jwt: { ...validEnvironment.jwt, tokenExpirationBuffer: 500 },
      };

      expect(() => service.validateEnvironment(env)).toThrowError(
        "Environment property 'jwt.tokenExpirationBuffer' must be a positive integer >= 1000",
      );
    });
    ...
    it('should throw error for invalid log level', () => {
      const env = {
        ...validEnvironment,
        logging: { ...validEnvironment.logging, logLevel: 'invalid' as any },
      };

      expect(() => service.validateEnvironment(env)).toThrowError(
        "Environment property 'logging.logLevel' must be one of: debug, info, warn, error",
      );
    });
  });
