...
- [NodeAngularFullStack Fullstack Architecture Document](#table-of-contents)
  ...
  - [External APIs](./external-apis.md)
    - [SendGrid API](./external-apis.md#sendgrid-api)
    - [Digital Ocean Spaces API](./external-apis.md#digital-ocean-spaces-api)
  ...
  - [Design Decisions](./design-decisions.md)
    - [Core Design Philosophy](./design-decisions.md#core-design-philosophy)
    - [Frontend Architecture Decisions](./design-decisions.md#frontend-architecture-decisions)
    - [Backend Architecture Decisions](./design-decisions.md#backend-architecture-decisions)
    - [Database Architecture Decisions](./design-decisions.md#database-architecture-decisions)
    - [Infrastructure Decisions](./design-decisions.md#infrastructure-decisions)
    - [Extension Guidelines](./design-decisions.md#extension-and-customization-guidelines)
  - [Component Interactions](./component-interactions.md)
    - [Authentication Flow](./component-interactions.md#authentication-flow)
    - [State Management Flow](./component-interactions.md#state-management-flow)
    - [Backend Service Architecture](./component-interactions.md#backend-service-architecture)
    - [Multi-Tenant Request Flow](./component-interactions.md#multi-tenant-request-flow)
    - [Extension Points](./component-interactions.md#extension-points)
  - [Extension Guide](./extension-guide.md)
    - [Frontend Extensions](./extension-guide.md#frontend-extensions)
    - [Backend Extensions](./extension-guide.md#backend-extensions)
    - [Database Extensions](./extension-guide.md#database-extensions)
    - [Authentication Extensions](./extension-guide.md#authentication-extensions)
    - [Testing Extensions](./extension-guide.md#testing-extensions)
    - [Deployment Extensions](./extension-guide.md#deployment-extensions)
